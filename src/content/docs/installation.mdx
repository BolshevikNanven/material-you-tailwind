---
title: Installation
description: How to install and configure the components manually.
image: '/develop.png'
---
...
```bash
pnpm add tailwindcss @tailwindcss/postcss clsx tailwind-merge class-variance-authority tw-animate-css @iconify/tailwind4
```

### 3. Configure PostCSS

Create or update your `postcss.config.mjs` file to include the Tailwind CSS plugin.
